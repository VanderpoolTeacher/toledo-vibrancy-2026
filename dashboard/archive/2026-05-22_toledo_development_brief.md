# Toledo Economic Development Brief — May 22, 2026
...
## Top story: The Blade to vacate century-old Superior Street headquarters — another legacy downtown property heads into disposition limbo
...
### $5 vehicle registration fee bump heads to council — closes a $1.9M road-fund deficit, with a May 26 procedural deadline
_Source: 2026-05-21_
...
Toledo currently sits at the lowest tier of regional fees. Sylvania, Bowling Green, Maumee, and Waterville already charge the full $30 cap. The vote arrives in the middle of Toledo's most aggressive residential road-reconstruction season in years — $36 million committed across 110 streets covering 43 miles, kicked off earlier in May. WTOL's coverage framed the proposal as 'we're taxing again,' which signals political resistance even within Council and suggests the May 26 deadline is going to be tight.
...
### Ostrich Towne: three tenants now open, CuriosiTEA the next opening to watch
_Source: 2026-05-18_

Ostrich Towne now has three operating tenants: Molly's Irish Pub, Avestruz Tapas & Tequila, and Riverside Barbeque Company, which held its grand opening in September 2025 at 915 N. Summit St. Riverside BBQ offers Texas-style smoked meats, a full bar, and live music in a converted beer distribution warehouse — a venue format well-suited to the district's industrial bones. CuriosiTEA Emporium remains the next expected opening, though no confirmed date has surfaced this window.

With three tenants open and Watershed Weekend foot traffic expected on the adjacent MLK Bridge in June, the district enters summer 2026 at a meaningfully different baseline than a year ago. The question for this season is whether the three-anchor cluster is enough to build dwell-time and return visits without a fourth or fifth tenant to extend the visit loop.

**Why it matters:** The Ostrich Towne thesis has always been 'anchor tenants plus Riverwalk tailwind equals a destination district.' Riverside BBQ's survival through its first winter confirms the first leg of that thesis. The watch item has shifted: CuriosiTEA's opening date is now the leading indicator for whether the district can sustain enough variety to pull repeat visitors. Watch the Vibrancy 19 property list — if any of the 19 awards land inside Vistula, the leasing pitch to the next wave of tenants gets materially easier.

**Sources:** [WTOL — Riverside BBQ grand opening](https://www.wtol.com/article/life/food/riverside-barbeque-company-opening-date-july-4-ostrich-towne-north-toledo/512-ff3ad4fe-3b93-495e-9ce2-10bd236e7b9d) · [WTOL — Ostrich Towne growth](https://www.wtol.com/article/money/business/small-business/vistula-district-ostrich-towne-growth-businesses-community-restaurants/512-dbe7ba1e-d81f-45e7-8d4c-99256a76d6c6) · [Ostrich Towne directory](https://ostrichtowne.com/directory/)
...
**Why it matters:** The stadium has moved from "trial balloon" to "filed proposal competing for state dollars" — a different category of project to track. The 140-event capacity figure is the real argument: at that volume the stadium functions as a year-round programming engine for Vistula, not just a 17-match-per-year venue. The state award timing is now the gating decision. A meaningful slice of the $1B fund makes this a 2028 anchor for the entire Vistula thesis; without it, the proposal slows or gets re-cut.
...
1. Toledo City Council vote on the $5 vehicle registration fee — procedural deadline May 26 to start the new rate for the 2027 registration year. A 'no' vote forces 2027 SCMR-fund cuts and weakens the site-readiness narrative.
2. The Blade Superior Street property disposition. Block Communications has not announced a timeline, destination, or property plan. Watch for a public listing, a TCIC engagement, or a mothballed-property scenario — that will set the comparable for adjacent owners.
3. Watershed Weekend June 11–14 — 20 days out. Programming is largely set; watch for business-district tie-ins from Vistula, Warehouse District, and East Toledo operators who want the halfway-point visibility moment.
4. Vibrancy 19 property list — still not published in full. Cluster patterns by Legacy Commercial Corridor are the signal. Any Vistula awards would accelerate Ostrich Towne's next leasing wave.
5. State $1B sports facility fund award timing. When Ohio names recipients, Summit Street Sports' $83.6M stadium either moves to budgeted or gets re-cut.
6. CuriosiTEA Emporium opening date at Ostrich Towne. With Riverside BBQ confirmed open, CuriosiTEA is now the make-or-break fourth tenant for the district's summer thesis.
7. Former Health District building disposition. $571K in demo funding is confirmed — watch for an RFP or TCIC Shovel Ready Sites designation on the cleared 1.8-acre downtown parcel.
8. Hotel Lorraine 72-hour facade deadline has lapsed (issued May 19). Watch for fines filed, an emergency demolition order, or movement on the sheriff's sale calendar.
9. Innovation Post lease specifics — square-foot allocations among Wurtec, WorkSpring, Junior Achievement of NW Ohio, and SEGULA, and day-one employee counts.
10. TCIC Shovel Ready Sites Fund — first site acquisition. 1400 N. Summit is the named target; watch for the RFP or board authorization on the actual land purchase and timeline.
11. Old South End housing pilot outcomes. The $1M initial tranche is live; watch for David Mann and the Land Bank to announce first RISE-designated properties entering the rehab pipeline.
12. Dorr Street duplex developer identity — the 32-lot Inverness Village applicant wasn't named at Plan Commission. Their track record will signal whether this is a one-off or a duplex-build cycle leading edge.
13. EVIS America 2026 (Nov 3–5, Glass City Center) — speaker announcements and exhibitor/sponsor list will signal which OEMs and mobility investors are being drawn into Toledo's orbit ahead of the summit.
14. RGP data-center pipeline — Gary Thompson has been working this sector for four years. Any hyperscale site announcement in the 17-county footprint would be the biggest RGP win since Meta.
